...
int gerarCalendario(dadosdasequipas equipasEDados[NUM_EQUIPAS], jogadores jogadoresPorEquipa[NUM_EQUIPAS][NUM_JOGADORES], int equipaSelecionada) {
    int jogosGerados = 0;
...
int main() {
    ...
    char continuar;
    do {
        gerarCalendario(equipasEDados, jogadoresPorEquipa, equipaSelecionada);
